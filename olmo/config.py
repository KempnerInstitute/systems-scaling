...
class EvaluatorConfig(BaseConfig):
    ...
    sft: bool = False
    ce_wrapper: bool = False
    ctx_ce_wrapper: bool = False
...
class TrainConfig(BaseConfig):
    ...
    requeue: bool = True
    """
    If True, requeue the job if it fails, i.e. load from ckpt with same name.
    """
    ...
    score_hf: bool = False
    """
    If True, then we only score a HF model (assumes just_score_model=True)
    """
