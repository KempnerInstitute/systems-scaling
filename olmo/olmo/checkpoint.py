...
def load_state_dict(
    ...
    *,
    ...
    return torch.load(path, map_location=map_location, weights_only=False) #weights_only=False idk if needed
...
class Checkpointer(metaclass=ABCMeta):
    ...
    def _temporary_wd(self, dir: PathOrStr) -> Generator[Path, None, None]:
        ...
        wait_for(lambda: checkpoint_dir.exists(), "Waiting for checkpoint directory", timeout=2000.0)
