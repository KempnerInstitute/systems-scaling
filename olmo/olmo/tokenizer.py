...
class Tokenizer:
    ...
    def bos_token(self) -> str:
        if self.bos_token_id is None:
            ...
            return self.decode([self.bos_token_id], skip_special_tokens=False)
    ...
    def num_special_tokens_to_add(self, is_pair: bool = False) -> int:
        if self.bos_token_id is None:
            ...
            bonus = 1
        return 2 * (1 + bonus) if is_pair else 1 + bonus
    ...
    def encode_batch(self, inputs: List[str], add_special_tokens: bool = True) -> List[List[int]]:
        ...
        # WARNING: preventing special tokens from base tokenizer!!
