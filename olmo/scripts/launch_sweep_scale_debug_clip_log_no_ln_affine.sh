...
#SBATCH --output=/n/holylfs06/LABS/kempner_dev/Lab/nikhilanand/systems-scaling-anon/systems-scaling/olmo/logs/%A_%a.log
#SBATCH --nodes=4    
...
export CHECKPOINTS_PATH="/n/netscratch/kempner_dev/Lab/nikhilanand/olmo_debug_no_affine/" # "/n/holylfs06/LABS/kempner_dev/Lab/nikhilanand/systems-scaling/ckpts"
