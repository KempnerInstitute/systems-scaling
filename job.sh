...
#SBATCH -p kempner_h100               # Partition name
#SBATCH --output=log/output_%j.txt
#SBATCH --error=log/error_%j.txt
#SBATCH --ntasks=4                    # Total number of tasks (2 GPUs/node x 2 nodes)
...
srun  torchrun --nproc_per_node 2 --rdzv_id $RANDOM --rdzv_backend c10d --rdzv_endpoint $head_node_ip:29500 ./gpu_2_nodes.py